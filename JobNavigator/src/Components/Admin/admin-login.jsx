...
function AdminLogin() {
    ...
    const handleData = async (data) => {
        ...
        const response = await axios.post(
            "http://localhost:6040/api/admin-login",
            payload, {
            headers: {
        ...
        if (response.data.code == 200) {
            ...
            localStorage.setItem("userType",JSON.stringify("admin"))//used for nav
            ...
            <div className="row">
                ...
                <div className="col-sm-8 ">
                    <div className="row ">
                        ...
                        <img src="../c19.png" className='seeker-background' style={{width:"100%",height:"100%"}} />
                        </div>

                        <div className="col-sm-6 form">
                            <h2 className="recruiter_div_signup">Admin Login</h2>
                            <div className="p-5" >
