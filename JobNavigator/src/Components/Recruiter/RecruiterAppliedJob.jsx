...
const RecruiterAppliedJob = () => {
    ...
    const getData = async () => {
        const tempData = JSON.parse(localStorage.getItem('data'));
        const payload={
            companyId:tempData._id
        }
        const response = await axios.post('http://localhost:6040/api/recruiter-applied', payload, {
            headers: {
                        ...
                        return (
                            ...
                            <div className="row d-flex justify-content-center align-items-center">
                                ...
                                <div className="col-md-3 d-flex justify-content-center align-items-center">
                                    <img src={`http://localhost:6040/upload/${el.img}`} alt="Company Logo" className="img-fluid bg-dark" style={{ maxHeight: '100px' }} />
                                </div>
                                ...
                                <div className="col-md-3">
                                    ...
                                    <div className='postedjob_p2 mb-2'><a href={`http://localhost:6040/upload/${el.logo}`} target="_blank">Download</a></div>
