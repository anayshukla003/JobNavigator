...
const SeekerApplyJobList = () => {
    ...
    const getData = async () => {
        ...
        const response = await axios.get('http://localhost:6040/api/seeker-joblist',  {
            headers: {
    ...
    const handleApply=async(element)=>{
       ...
       const response=await axios.post("http://localhost:6040/api/seeker-applyjob",payload,{
        headers:{
            "Content-Type":"application/json"
        }
       })
